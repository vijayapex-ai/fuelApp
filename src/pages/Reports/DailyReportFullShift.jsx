...
const FullShiftReport = () => {
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        const res = await fetch(`http://localhost:5000/api/fullshiftreport/summary?date=${selectedDate}`);
    ...
    const fetchDaybookReceipts = async () => {
      try {
        const res = await fetch(
          `http://localhost:5000/api/fullshiftreport/daybook-receipts?date=${selectedDate}`
        );
        const data = await res.json();
    ...
    const fetchRetailSales = async () => {
      try {
        const res = await fetch(
          `http://localhost:5000/api/fullshiftreport/produtsaleretail?date=${selectedDate}`
        );
        const data = await res.json();
        setRetailSales(data|| []);
      } catch (err) {
    ...
    const fetchGstSales = async () => {
      try {
        const res = await fetch(
          `http://localhost:5000/api/fullshiftreport/produtsalegst?date=${selectedDate}`
        );
        const data = await res.json();
        setGstSales(data|| []);
      } catch (err) {
    ...
    const fetchTaxSumamry = async () => {
      try {
        const res = await fetch(
          `http://localhost:5000/api/fullshiftreport/tax-summary?date=${selectedDate}`
        );
        const data = await res.json();
        setTaxSummary(data|| []);
      } catch (err) {
    ...
    const fetchCreditBills = async () => {
      try {
        const res = await fetch(
          `http://localhost:5000/api/fullshiftreport/credit-bills?date=${selectedDate}`
        );
        const data = await res.json();
        setCreditBills(data|| []);
      } catch (err) {
